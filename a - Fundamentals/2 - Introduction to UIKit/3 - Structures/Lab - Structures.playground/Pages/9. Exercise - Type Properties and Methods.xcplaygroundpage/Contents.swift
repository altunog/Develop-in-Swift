 ...
 */
struct User {
    static var currentUser: User = User(userName: "Heisenberg", email: "heisenberg@ww.com", age: 46)
    ...
    static func logIn(user: User) {
        currentUser = user
        print("\(currentUser.userName) has just logged in.")
    }
}
 ...
 */
var newUser = User(userName: "SaulGoodman", email: "saulgoodman@lawyrup.com", age: 45)

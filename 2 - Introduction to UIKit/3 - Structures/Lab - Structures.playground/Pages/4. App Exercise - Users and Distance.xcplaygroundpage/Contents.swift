...
var heisenberg = User(name: "Walter", age: 46, height: 180, weight: 84, activityLevel: 9)
print("My name is \(heisenberg.name). I am \(heisenberg.age) years old. My weight is \(heisenberg.weight) kg and activity level is \(heisenberg.activityLevel).")
/*:

...
struct Height {
    var heightInInches: Double {
        didSet {
            if heightInInches != oldValue && heightInInches != heightInCentimeters / 2.54 {
    ...
    var heightInCentimeters: Double {
        didSet {
            if heightInCentimeters != oldValue && heightInCentimeters != heightInInches * 2.54 {

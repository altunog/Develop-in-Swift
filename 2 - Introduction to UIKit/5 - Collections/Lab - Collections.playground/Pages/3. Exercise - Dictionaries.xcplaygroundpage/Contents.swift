...
var shapesArray: [String] = ["triangle", "rectangle", "circle"]
var colorsArray: [String] = ["yellow", "purple", "white"]
...
if let colors = shapesAndColors["Colors"] {
    let colorsQty = colors.count
    print(colorsQty > 0 ? colors[colorsQty-1] : "no color")
